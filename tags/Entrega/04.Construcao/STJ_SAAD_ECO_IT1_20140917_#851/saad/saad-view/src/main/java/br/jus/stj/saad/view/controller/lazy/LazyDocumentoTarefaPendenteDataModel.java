...
public class LazyDocumentoTarefaPendenteDataModel extends
	...
	public LazyDocumentoTarefaPendenteDataModel(DocumentoBean bean,
			LoginBean loginBean) {
	...
	public List<Documento> load(int first, int pageSize, String sortField,
		...
		documentos = documentoBean.documentosTarefasPendentesLocalLazy(first,
	...
	public int getRowCount() {
		if(null == rowCount){
			rowCount = documentoBean.documentosTarefasPendentesLocalLazyCount(
