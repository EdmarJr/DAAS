...
public class AuditoriaDocumento extends EntidadeBase implements
	...
	public AuditoriaDocumento(Documento documento, Usuario usuario,
		...
		this.idDestinatario = documento.getDestinatario() != null ? documento
				.getDestinatario().getId() : null;
		this.idEnderecado = documento.getEnderecamento() != null ? documento
				.getEnderecamento().getId() : null;
