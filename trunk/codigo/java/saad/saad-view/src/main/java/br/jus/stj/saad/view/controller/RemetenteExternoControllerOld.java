...
//@ManagedBean
//@ViewScoped
//public class RemetenteExternoControllerOld extends GenericController {
//
//	/**
//	 * 
//	 */
...
//			if(documento != null){
//				documento = documentoBean.inicializar(documento,"tarefas","anexos","local", "destinatario", "enderecamento");
//				if(documento.getDestinatarioDocumento() != null){
//					nomeDestinatario = documento.getDestinatarioDocumento().getNome();
//					documento.setInterfaceDestinatario(documento.getDestinatarioDocumento());
//				}else{
//					documento.setInterfaceDestinatario(documento.getEnderecamento().getDestinatario());
//				}
//			}
//		}		
//	}
...
//		
//		if(retorno.size() < 1){
//			documento.getInterfaceDestinatario().setNome(nomeDestinatario);
...
//			}
//		}else{
//			getDocumento().getInterfaceDestinatario().setNome(nomeDestinatario);
//		}
//	}
//	
...
//	}
//
//	public Boolean getDocumentExternal() {
