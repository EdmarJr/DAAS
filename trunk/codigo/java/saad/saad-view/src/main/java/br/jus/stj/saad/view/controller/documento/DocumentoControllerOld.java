...
public abstract class DocumentoControllerOld extends GenericController {
	...
	public Boolean isDocumentExternal() {
		if (getDocument().getTipoOrigem().equals(
