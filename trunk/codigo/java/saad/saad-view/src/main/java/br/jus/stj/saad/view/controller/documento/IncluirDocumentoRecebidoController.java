...
@ViewScoped
@ManagedBean
public class IncluirDocumentoRecebidoController extends DocumentoController {
	...
	public void init() {
		super.init();
		getDocumento().setTipoClassificacaoDocumento(ClassificacaoEnum.RECEBIDO.getValor());
	}
